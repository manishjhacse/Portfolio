    ...
    return (
        <div className='md:w-[30%] md:h-screen pt-14'>
            ...
            <div className='flex flex-col md:items-start items-center gap-y-3'>
                ...
                <div className='text-slate-400'>Full Stack MERN Developer</div>
                ...
                <p className='text-slate-400'>
                    Full Stack MERN Developer with real-world experience and a passion for building powerful, user-first web applications that solve meaningful problems through technology.
                </p>
