...
export default function Form() {
  ...
  return (
    <form className="flex flex-col w-[75%] gap-4" onSubmit={handleSubmit}>
      ...
      <button className="hover:bg-[#2d4481] w-fit bg-[#4070f4] flex items-center gap-3 transition-all duration-200 text-white md:text-xl font-bold md:px-4 md:py-2 px-2 py-1 rounded-md" type="submit" disabled={state.submitting}>
